...
public:
   ...
   */
 enum class KrcahImplementationEnum: u_int8_t {
 ...
 static constexpr KrcahImplementationEnum UseImplementationParameters = KrcahImplementationEnum::UseImplementationParameters;
